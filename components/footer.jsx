        ...
        <div className="flex flex-col">
          <div class="sm:flex sm:items-center sm:justify-between lg:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400 w-full justify-between">
              ...
              <div class="flex mt-4 space-x-9 sm:justify-center sm:mt-0 p-4 bg-black rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-500" />
              <a
                href="#"
              ...
              <div class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <span class="">Instagram page</span>
              </div>
              <div class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg
                  class="w-5 h-5"
            ...
            >
              ...
              <div class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <span class=" not-sr-only">Dribbbel account</span>
                <div />
              </div>
            </ul>
          </div>
